      ...
      <main className="max-w-7xl mx-auto py-12 sm:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            whileTap={{ scale: 0.97 }}
            className="mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-br from-black/90 via-black/80 to-black/90 border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)] bg-clip-text"
          >
            <FcGoogle size={22} />
...
function Feature({ icon, title, des }) {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-3xl mb-3">{icon}</div>
      <h3 className="relative z-10 text-xl font-semibold mb-2">{title}</h3>
      <p className="relative z-10 text-gray-300 text-sm leading-relaxed">{des}</p>
    </motion.div>
  );
}
