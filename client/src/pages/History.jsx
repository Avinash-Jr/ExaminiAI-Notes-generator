...
import allEvents from "../data/history.js";
...
const kinds = [ALL, ...new Set(allEvents.map((event) => event.kind))];
    ...
    <Container className="py-14 sm:py-20">
      ...
      {count === 0 ? (
        <div className="mt-4">
          ...
          >
            Once you generate or export something, it turns up here with the
            credits it used.
          </EmptyState>
        </div>
      ) : (
